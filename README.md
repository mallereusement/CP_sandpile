...
- `scipy` for chi2 distribution

To install the required packages, you can use `pip`:

```bash
pip install numpy iminuit pandas uncertainties tqdm matplotlib scipy
```
...
Future plans could include analyzing the power spectrum data that can allready be generated by the code and compare it with and without avalanche interference.
